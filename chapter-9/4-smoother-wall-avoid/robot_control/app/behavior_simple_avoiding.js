...
export default function Page({ navigation }) {
    ...
    global.mqttClient.subscribe("log/obstacle_avoiding/simple");
    ...
    useNavigation().addListener('beforeRemove', (e) => {
        global.mqttClient.unsubscribe("log/obstacle_avoiding/simple");
    });
    ...
    return (
        <View style={styles.container}>
            ...
            <Link href="/">Back</Link>
            <Button title="Start" onPress={() => global.mqttClient.publish("launcher/start", "behavior_simple_avoiding")} />
            <Button title="Stop" onPress={() => global.mqttClient.publish("launcher/stop", "behavior_simple_avoiding")} />
            <View>
